...
import numpy as np
import pandas as pd
df = pd.read_csv('./result/2view_Custom/3D_Point_Clouds_Two_Views.csv', sep=',', header=None)
...
o3d.io.write_point_cloud("./result/2view_Custom/3D_Point_Clouds_Two_Views.ply", pcd)